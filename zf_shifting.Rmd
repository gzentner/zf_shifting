...
for(i in c("exd2")) {
  gene_tracks(exp, feature_name = i, promoter_only = TRUE, 
              samples = c(TSS = "unfertilized.egg", TSS ="fertilized.egg"),
              use_normalized = FALSE, axis_scale = 1, upstream = 50, 
              downstream = 50, feature_type = "gene", 
